 ...
 * of the app).
 */
public class PoliciesFragment extends SherlockFragment implements
	 ...
	 */
	public static PoliciesFragment newInstance(boolean onlyShowPolicies) {
		final PoliciesFragment f = new PoliciesFragment();
...
*/
	...
	public void showFragmentsDialog(boolean savedInstanceState) {
		...
		dialgoFragment = fragManager.findFragmentByTag(
	...
	private void ensureWebView() {
		...
		mWbvPolicies.setBackgroundColor(Color.TRANSPARENT);
		Typeface font = Typeface.createFromAsset(getActivity().getAssets(), "fonts/Planer_Reg.ttf");
		mBtnContinue.setTypeface(font);
		//textView

		//String dir = "@font-face {font-family: cool_font;src: url('file://"+ getFilesDir().getAbsolutePath() + "/cool_font.ttf');}";
//mWbvPolicies.
		mWebViewShown = true;
